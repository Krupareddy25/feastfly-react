export default function MenuFilters({
  ...
  return (
    <>
      {/* CATEGORY FILTERS */}
      <section className="fm-category-bar">
        <div className="container fm-category-container">
          <button
            className={selectedCategory === "All" ? "fm-cat active" : "fm-cat"}
          ...
          {categories.map((cat) => (
            <button
              key={cat}
              className={selectedCategory === cat ? "fm-cat active" : "fm-cat"}
      ...
      {/* FILTER BAR */}
      <section className="fm-filter-bar">
        <div className="container fm-filter-container">
          <div className="fm-veg-filter">
            <button
              className={`veg-btn ${typeFilter === "veg" ? "active" : ""}`}
            ...
            >
              ...
              <span className="nonveg-text">Non-Veg</span>
            </button>
          </div>
          <div className="fm-other-filters">
            <button
